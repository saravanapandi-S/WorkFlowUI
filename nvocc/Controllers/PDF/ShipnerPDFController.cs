...
namespace nvocc.Controllers.PDF
{
    ...
    [ApiController]
    public class ShipnerPDFController : ControllerBase
    {
        ...
        public ShipnerPDFController(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        [HttpPost("ShipnerPrintPDF")]
        public List<MyCountry> BLPrintPDF(MyCountry Data)
        {
            ...
            var pdfpath = Path.Combine("ClientApp//src//assets//pdfFiles//shipner/");
            MergeEx pdfmp = new MergeEx();
            pdfmp.SourceFolder = pdfpath;

            pdfmp.DestinationFile = pdfpath + "Multiple-BL.pdf";
            string FileHidpath = "ClientApp//src//assets//pdfFiles//shipner/Multiple-BL.pdf";
            ...
            cb.SetColorFill(iTextSharp.text.BaseColor.BLACK);
            iTextSharp.text.Image png1 = iTextSharp.text.Image.GetInstance(Path.Combine("ClientApp//src//assets//images//bllogos/shipner.png"));
            png1.SetAbsolutePosition(15,780);
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Booking No", 335, 758, 0);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Export Reference", 335, 746, 0);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Service Contract", 335, 734, 0);
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Shipner Shipping and Agencies Pvt Ltd", 450, 30, 0);
            cb.EndText();
