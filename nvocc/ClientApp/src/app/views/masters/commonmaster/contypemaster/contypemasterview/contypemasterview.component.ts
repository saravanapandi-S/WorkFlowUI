...
import { ContainerType } from '../../../../../model/common';
...
@Component({
    ...
    templateUrl: './contypemasterview.component.html',
    styleUrls: ['./contypemasterview.component.css']
})
export class ContypemasterviewComponent implements OnInit {
    title = 'ContainerType Master';
