...
export declare const configurableDefaultOptions: readonly ["ariaLabel", "clearSearchInput", "closeIcon", "closeSvgIcon", "disableInitialFocus", "disableScrollToActiveOnOptionsChanged", "enableClearOnEscapePressed", "hideClearSearchButton", "indexAndLengthScreenReaderText", "noEntriesFoundLabel", "placeholderLabel", "preventHomeEndKeyPropagation", "searching"];
...
/** @deprecated */
export declare const configurableGlobalOptions: readonly ["ariaLabel", "clearSearchInput", "closeIcon", "closeSvgIcon", "disableInitialFocus", "disableScrollToActiveOnOptionsChanged", "enableClearOnEscapePressed", "hideClearSearchButton", "indexAndLengthScreenReaderText", "noEntriesFoundLabel", "placeholderLabel", "preventHomeEndKeyPropagation", "searching"];
/** @deprecated */
export declare type ConfigurableGlobalOptions = ConfigurableDefaultOptions;
/** @deprecated */
export declare const MATSELECTSEARCH_GLOBAL_OPTIONS: InjectionToken<Readonly<Partial<Pick<MatSelectSearchComponent, "ariaLabel" | "clearSearchInput" | "closeIcon" | "closeSvgIcon" | "disableInitialFocus" | "disableScrollToActiveOnOptionsChanged" | "enableClearOnEscapePressed" | "hideClearSearchButton" | "indexAndLengthScreenReaderText" | "noEntriesFoundLabel" | "placeholderLabel" | "preventHomeEndKeyPropagation" | "searching">>>>;
